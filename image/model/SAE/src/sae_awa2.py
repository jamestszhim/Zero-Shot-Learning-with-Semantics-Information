...
def main():
	...
	'''
	# food 11 dataset:
	train_data = np.load('../food_data/resnet101_trainfeatures.npy')
	test_data = np.load('../food_data/resnet101_testfeatures.npy')
	train_class_attributes_labels_continuous_allset = np.load('../food_data/Food11_train_Label_attributelabel.npy')
	opts.test_labels = np.load('../food_data/Food11_testlabel.npy')
	test_classes_id_list = [0, 5, 9]
	opts.test_classes_id = np.asarray(test_classes_id_list)
	test_class_attributes_labels_continuous = np.load('../food_data/S_te_gt_food_Label.npy')
	'''
